...
#Тест 3 Ошибка 400 Bad request при количестве символов имени меньше допустимого (1 символ)
def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert_symbol("А")
# Тест 4 Ошибка при количестве символов больше допустимого (16 символов)
def test_create_user_16_letter_in_first_name_get_error_response():
    negative_assert_symbol("ААаааааааааааааа")
# Тест 5. Успешное создание пользователя. Параметр firstName состоит из символов английского алфавита
def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("QWErty")
# Тест 6. Успешное создание пользователя. Параметр firstName состоит из символов кириллицы
def test_create_user_russian_letter_in_first_name_get_success_response():
    positive_assert("Мария")
#Тест 7 Ошибка 400 Bad request при вводе запрещенных пробелов в имени
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Человек и Ко")
#Тест 8 Ошибка 400 Bad request при вводе запрещенных спецсимволов в имени
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("№%@")
#Тест 8 Ошибка 400 Bad request при вводе запрещенных цифр в имени
...
def test_create_user_empty_first_name_get_error_response():
    ...
    # Проверка полученного ответа
    negative_assert_no_first_name(user_body)
#Тест 12 Ошибка 400 Bad request при передаче тип параметра firstName: число
